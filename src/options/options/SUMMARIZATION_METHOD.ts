...
export const shouldSummPagebyPage = (method: string): boolean =>
  method === SUMMARIZATION_METHOD[1];
export const shouldSummAggr = (method: string): boolean =>
  method === SUMMARIZATION_METHOD[0];
